...
int main(int argc, char *argv[]){
    // RICORDA:
        //Inserire obbligatoriamente un numero nella command line altrimenti non funziona
    unsigned int dim_vect=stoi(argv[1]); // converto in intero il numero preso dalla command line
    int contatore=100;
...
//*******************************************************************************************************************
    ...
    for(unsigned int i=0;i<dim_vect;i++)
        vect_1[i]=rand() % 100;
    cout<<"Il vettore di partenza e' (non ordinato): ";
    for(unsigned int i=0;i<dim_vect;i++)
        cout<<vect_1[i]<<" ";
    cout<<endl;
